    ...
    {     
        ...
        try
        {
            ...
            model.resourceGrowerDefinition =
                gameContext.AutoSaveDirector._saveReferenceTranslation._resourceGrowerTranslation.RawLookupDictionary
                    ._entries.FirstOrDefault(x =>
                        x.value._primaryResourceType == identifiableTypes[packet.ident]).value;
